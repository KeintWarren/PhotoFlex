...
export default function PinDetailModal({
  ...
  const handleAddComment = async () => {
    ...
    try {
      ...
      const saved = await apiFetch("/comments", {
        method: "POST",
        body: JSON.stringify(payload),
      });

      setComments([...comments, { ...saved, user: currentUser }]);
      setNewComment("");
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 flex flex-col p-6 overflow-y-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
              <img
                src={
                  pin.user?.profilePicture ||
                  "https://placehold.co/48x48/A855F7/ffffff?text=U"
                }
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <button className="px-4 py-2 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-full font-semibold hover:shadow-lg transition">
                Save
              </button>
            </div>
